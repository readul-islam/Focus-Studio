...
function IconButton({
  ...
  return (
    <motion.button
      ...
      className={cn(
        `group/icon-button relative cursor-pointer inline-flex size-10 shrink-0 rounded-full hover:bg-[var(--icon-button-color)]/10 active:bg-[var(--icon-button-color)]/20 text-[var(--icon-button-color)]`,
        sizes[size],
        className,
      )}
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {active && (
          <motion.div
            className="absolute text-[var(--icon-button-color)] fill-[var(--icon-button-color)]"
            aria-hidden="true"
