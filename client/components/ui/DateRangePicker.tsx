...
export interface DateRangePickerProps {
  ...
  showCompare?: boolean
  /** Option for small screen optimization */
  isSmall?: boolean
}
...
export const DateRangePicker: FC<DateRangePickerProps> & {
  ...
  // console.log('checking',initialDateFrom, initialDateTo)
    ...
    setRange({
      from:
        typeof initialDateFrom === 'string'
          ...
          : initialDateFrom,
      to:  typeof initialDateTo === 'string'
          ? getDateAdjustedForTimezone(initialDateTo)
          : initialDateTo
  ...
  return (
    ...
    >
      <PopoverTrigger asChild>
        <Button disabled={disabled} className='w-full pl-4 disabled:opacity-100 disabled:cursor-not-allowed' size={'default'} variant="outline">
         ...
         {!disabled && <div className="pl-1 opacity-60 -mr-2 scale-125">
            {isOpen ? (<ChevronUpIcon width={24} />) : (<ChevronDownIcon width={24} />)}
          </div>}
        </Button>
      </PopoverTrigger>
      <PopoverContent align={align} side={side} className="w-auto">
