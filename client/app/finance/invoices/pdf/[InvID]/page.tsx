...
const Invoice = ({ params }) => {
  ...
  const { data, isLoading, isError, error } = useFetch(`finance/invoices/${id}/`);
  ...
  useEffect(() => {
    if (data && !isLoading && !isError) {
      ...
      if (data?.display_invoice) {
        document.title = data?.project?.project_name + " - " + data.display_invoice;
      }
      ...
      <div className="p-8 min-h-screen text-gray-800">
        ...
        <div className="flex justify-between mb-16">
          <div className="flex-1">
            ...
            <h2 className="text-xl font-normal mb-5 text-black">#{data?.display_invoice}</h2>
