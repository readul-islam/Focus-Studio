          ...
          {!isResetMode ? (
            <>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                {/* Inline error */}
                {formError && (
                  <p className="text-xs text-red-600 mt-1.5 mb-0">{formError}</p>
                )}
                ...
                <div className="flex justify-end mt-2 mb-5">
                  <button
                    type="button"
                    onClick={() => { setIsResetMode(true); setFormError(''); }}
              ...
              {resetSent ? (
                <div className="flex flex-col gap-5 py-2">
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-emerald-50 border border-emerald-100">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900 mb-0.5">Reset link sent</p>
                  ...
                  <div className="flex items-start gap-3 p-3.5 rounded-xl bg-amber-50 border border-amber-100">
                    ...
                    <p className="text-xs text-amber-700 leading-relaxed">
                      This link expires in <span className="font-semibold">15 minutes</span>. Check your spam folder if you don&apos;t see it.
                    </p>
                  </div>
                ...
                <form onSubmit={handleForgotPassword} noValidate>
                  <div className="mb-5">
                    ...
                    {resetError && <p className="text-xs text-red-600 mt-1.5">{resetError}</p>}
                  </div>
