...
import { ProjectPresenceStrip } from '@/components/project/ProjectPresenceStrip';
import {
  ProjectCollaborationProvider,
  useProjectCollaborationContext,
} from '@/components/project/ProjectCollaborationProvider';
...
export default function ProjectLayout({
  ...
  const { isLoading: projectLoading, isError: projectError } = useFetch(
    `projects/projects/${params?.id}`,
    { enabled: !!params?.id }
  );
  ...
  if (projectError || params?.id == 'null' || params?.id == 'undefined') {
