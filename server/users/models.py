...
PERMISSION_CHOICES = [
    ...
    ('presentations.view', 'Presentations • view'),
    ('presentations.edit', 'Presentations • edit'),
    ('presentations.delete', 'Presentations • delete'),
    ('presentations.share', 'Presentations • share'),
    ('team.view', 'Team • view'),
    ('team.edit', 'Team • edit'),
