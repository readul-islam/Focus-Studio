        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <Link href="/auth/forgot-password" className="text-xs text-stone-900 hover:underline">
                Forgot password?
              </Link>
            </div>
      ...
      <div className="hidden lg:flex lg:flex-1 relative bg-stone-100">
        ...
        <div className="absolute inset-0 bg-black/20 flex flex-col justify-center px-12 xl:px-16">
          <div className="max-w-lg">
            <h2 className="text-4xl font-bold text-white mb-4 leading-tight">Welcome back to your design studio</h2>
            <p className="text-lg text-white/90 mb-8">
              Continue managing your projects, clients, and procurement with Techstyles' powerful platform.
            </p>
