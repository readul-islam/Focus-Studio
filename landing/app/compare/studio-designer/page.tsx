...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("compareDetailPages.studio-designer.meta")
  return {
    title: t("title"),
    ...
    alternates: localeHreflangAlternates("compare/studio-designer"),
  }
}

export default function FocuspilotVsStudioDesignerPage() {
  return <CompareDetailPageContent slug="studio-designer" />
}
