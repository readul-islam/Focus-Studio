...
export const metadata: Metadata = {
  title: "Contact Focuspilot | Get in Touch",
  description: "Contact the Focuspilot team. We'd love to hear from you - whether you have questions about our interior design software or want to book a demo.",
    ...
    <main className="min-h-screen bg-white">
      <div className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <p className="mt-6 text-lg text-stone-600">
          Have questions about Focuspilot? Want to book a demo? We'd love to hear from you.
        </p>
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-stone-200 p-6">
            ...
            <p className="mt-2 text-sm text-stone-600">See Focuspilot in action</p>
