      ...
      <div className="mx-auto max-w-3xl px-6 py-24">
        ...
        <div className="mt-12 space-y-8 text-stone-600">
          ...
          <section>
            ...
            <p className="mt-3">
              We use your information to provide and improve Focuspilot, communicate with you, and ensure security. We never sell your data to third parties.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Under GDPR, you have the right to access, correct, delete, or export your data. Contact us at privacy@focuspilot.io to exercise these rights.
            </p>
          </section>
