    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
        <div className="flex items-center gap-3">
          {/* <BanknoteArrowUpIcon className="w-4 h-4 text-gray-500" aria-hidden="true" /> */}
          <svg
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500">Total paid till today</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500">Total due till today</p>
          </div>
        </div>
      </div>
    </div>
