  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:bg-gray-100 rounded-sm transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2",
        day_selected: "bg-[#1e1e1e] text-white hover:bg-[#2d2d2d] hover:text-white focus:bg-[#1e1e1e] focus:text-white",
